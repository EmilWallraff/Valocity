...
function Home() {
  ...
  const pages = [
    ...
    },
    {
      ...
      image: "/images/valorant/abilities/92EEEF5D-43B5-1D4A-8D03-B3927A09034B_Ultimate.png",
      path: userinfo ? `/playerprofile/${userinfo.gameName}_${userinfo.tagLine}` : "/login",
    },
    {
